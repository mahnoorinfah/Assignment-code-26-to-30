...
let version:string = 'a5';
let version2: string = "a7";
if (version = 'a5') {
    console.log(version);
...
let versionofProgram:string[] =['A4','A6','A8'];
if (alien_color[0] ) {
...
/*Stages of life:Write an if-else chain that determines a person's stage of life.Set a value for the variable
 ...
 if (age < 2) {
    ...
    console.log(`Age is ${age}, The person is a toodler.`);
...
const favourite_fruits:string[] =["apple", "mango","bananas"]
...
if(favourite_fruits.includes("papaya")){
 ...
 const userName:string[] = ["riha", "fija", "admin", "minha", "saba"]
